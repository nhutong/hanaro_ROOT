...
//console.log(jsonResult.CompanyList);
		...
		for(var i in jsonResult_comp){
			...
			text +='	<div class="locationClick" style="width:250px;" onclick="convertToMain('+jsonResult_comp[i].VM_CP_NO+', \''+jsonResult_comp[i].VM_CP_NAME+'\');">';
...
//매장페이지로 이동하기
function convertToMain(rcvCPNO, cp_name){

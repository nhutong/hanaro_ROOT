$(function(){
    ...
    $("#infoSubmitBtn").on("click",function(){
		...
		/*2020-02-18 주석처리 한 부분 - 나영*/
		$.ajax({
			url:'https://www.nhhanaromart.com/back/01_sign/myInfoUpdate.jsp?random=' + (Math.random()*99999), 
...
function myInfo(rcvMemberNo){
	...
	$.ajax({
        url:'https://www.nhhanaromart.com/back/01_sign/myInfo.jsp?random=' + (Math.random()*99999), 

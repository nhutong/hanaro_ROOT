...
//		rs.beforeFirst();
		...
		if("REQUESTED".equals((String)previous.get("statusCd")) && "APPROVED".equals(status)) {
			...
			"				     <p style=\"font-family:'Noto Sans KR', sans-serif; margin:3.3783% 0 0 0; font-size:0.375em; color:#666666; letter-spacing:-0.025em; line-height:1.4583em;\">하나로마트 관리자 승인이 완료되었습니다.<br> www.nhhanaromart.com</p>" +
			"				   </article>" +

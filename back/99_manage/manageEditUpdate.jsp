...
//		rs.beforeFirst();
        ...
        "				<div style=\"position:relative; text-align:right; border-bottom:2px solid #55b190; line-height:0; padding-top:14.1891%; padding-bottom:2.027%;\">" +
        ...
        "				     <p style=\"font-family:'Noto Sans KR', sans-serif; margin:3.3783% 0 0 0; font-size:0.375em; color:#666666; letter-spacing:-0.025em; line-height:1.4583em;\">회원가입 승인이 완료되었습니다.<br> <a href=\"http://www.nhhanaromart.com\"><span style=\"text-decoration: none; color:#666666;\">https://www.nhhanaromart.com</span></a></p>" +
        "				   </article>" +

...
//			+" and left(a.start_date,10) <= left(now(),10) "
			+" and left(a.end_date,10) >= left(now(),10) "
			+" and a.coupon_type = 'PRODUCT' "
			+" GROUP BY a.coupon_no, a.discount_price, a.coupon_type, date_format(a.start_date,'%m-%d'), date_format(a.end_date,'%m-%d'), a.product_name, (a.limit_qty - ifnull(d.coupon_save_cnt,0)), min_price "
			+" order by a.end_date desc ";

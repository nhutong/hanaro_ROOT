...
//	mariadb의 페이징 시작 쿼리를 위해 1을 뺀다.
	...
	try{
		...
		sql = " SELECT " 
		+ "  p.pm_no, p.ms_content, p.event_no as event_title, a.vm_cp_name, p.pm_hour, p.pm_min, ifnull(b.send_cnt,0) as send_cnt, ifnull(c.target_cnt,0) as target_cnt, p.reg_date, p.pm_from_date, p.pm_to_date, p.pm_interval, p.pm_target, p.pm_type, ifnull(p.send_date,'') as send_date "

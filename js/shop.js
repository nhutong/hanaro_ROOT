...
var tpl_tr_tab1_table = _.template('<tr data-no="<%- no %>"><td><%- no %></td>' +
	...
	'<td><span class="shopUrl" onclick="window.open(\'../app/home/main.html?vm_cp_no=<%- no %>\',\'_blank\',\'width=414 , height=650, resizable=no, left=500, top=200\'); localStorage.setItem(\'vm_cp_no\',<%- no %>)">http://www.nhhanaromart.com/app/home/main.html?vm_cp_no=<%- no %></span></td>' +
	'<td><%- regDate %></td>' +

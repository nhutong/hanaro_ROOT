...
//		$ul.append('<li rel="tab6" class="nav_delivery" onclick="delivery();">배송</li>');
		...
		$ul.append('<li><a href="http://172.16.9.22/download/admin_manual.pdf" target="_blank" style="color:#fff;text-decoration:none;">매뉴얼</a><span style="font-size:12px;background-color:#55b190;padding:0.1px 6px;border-radius:50%;cursor:pointer;margin-left:4px;">?</span></li');
	}    
}
